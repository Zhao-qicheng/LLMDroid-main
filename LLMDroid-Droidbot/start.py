...
def parse_args():
    ...
    parser.add_argument("-code_coverage", action="store", dest="code_coverage",
                        choices=["time", "androlog", "jacoco"], default="time",
                        help="Code coverage monitor to use. Use 'time' for normal APKs without instrumentation.")
