...
class ADB(Adapter):
    ...
    def run_cmd(self, extra_args, timeout=None):
        """
        ...
        r = subprocess.check_output(args, timeout=timeout).strip()
    ...
    def shell(self, extra_args, timeout=None):
        """
        ...
        return self.run_cmd(shell_extra_args, timeout=timeout)
